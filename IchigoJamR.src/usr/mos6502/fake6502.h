...
#define brk mos6502_brk

//6502 CPU registers
uint16 mos6502_pc;
#define pc mos6502_pc
...
#define overflowcalc(n, m, o) { /* n = result, m = accumulator, o = memory */ \
    if (((n) ^ (uint16)(m)) & ((n) ^ (o)) & 0x0080) setoverflow();\
        else clearoverflow();\
}
...
uint16 oldpc, ea, reladdr, value, result;
uint8 opcode, oldstatus;

//externally supplied functions
extern uint8 read6502(uint16 address);
extern void write6502(uint16 address, uint8 value);

//a few general functions used by various other functions
void push16(uint16 pushval) {
...
uint16 pull16() {
    uint16 temp16;
    temp16 = read6502(BASE_STACK + ((sp + 1) & 0xFF)) | ((uint16)read6502(BASE_STACK + ((sp + 2) & 0xFF)) << 8);
    sp += 2;
    return(temp16);
}
...
void reset6502() {
    pc = (uint16)read6502(0xFFFC) | ((uint16)read6502(0xFFFD) << 8);
    a = 0;
    x = 0;
    y = 0;
    sp = 0xFD;
...
static void zp() { //zero-page
    ea = (uint16)read6502((uint16)pc++);
}

static void zpx() { //zero-page,X
    ea = ((uint16)read6502((uint16)pc++) + (uint16)x) & 0xFF; //zero-page wraparound
}

static void zpy() { //zero-page,Y
    ea = ((uint16)read6502((uint16)pc++) + (uint16)y) & 0xFF; //zero-page wraparound
}

static void rel() { //relative for branch ops (8-bit immediate value, sign-extended)
    reladdr = (uint16)read6502(pc++);
    if (reladdr & 0x80) reladdr |= 0xFF00;
}

static void abso() { //absolute
    ea = (uint16)read6502(pc) | ((uint16)read6502(pc+1) << 8);
    pc += 2;
}
...
static void ind() { //indirect
    uint16 eahelp, eahelp2;
    eahelp = (uint16)read6502(pc) | (uint16)((uint16)read6502(pc+1) << 8);
    eahelp2 = (eahelp & 0xFF00) | ((eahelp + 1) & 0x00FF); //replicate 6502 page-boundary wraparound bug
    ea = (uint16)read6502(eahelp) | ((uint16)read6502(eahelp2) << 8);
    pc += 2;
}

static void indx() { // (indirect,X)
    uint16 eahelp;
    eahelp = (uint16)(((uint16)read6502(pc++) + (uint16)x) & 0xFF); //zero-page wraparound for table pointer
    ea = (uint16)read6502(eahelp & 0x00FF) | ((uint16)read6502((eahelp+1) & 0x00FF) << 8);
}

static void indy() { // (indirect),Y
    uint16 eahelp, eahelp2, startpage;
    eahelp = (uint16)read6502(pc++);
...
static uint16 getvalue() {
    if (addrtable[opcode] == acc) return((uint16)a);
        else return((uint16)read6502(ea));
}

static uint16 getvalue16() {
    return((uint16)read6502(ea) | ((uint16)read6502(ea+1) << 8));
}

static void putvalue(uint16 saveval) {
...
static void adc() {
    penaltyop = 1;
    value = getvalue();
    result = (uint16)a + value + (uint16)(status & FLAG_CARRY);
...
static void brk() {
    ...
    pc = (uint16)read6502(0xFFFE) | ((uint16)read6502(0xFFFF) << 8);
}
...
void nmi6502() {
    ...
    pc = (uint16)read6502(0xFFFA) | ((uint16)read6502(0xFFFB) << 8);
}
