...
// ver 1.0.0 = 10017 次は、10101 からスタート
// ver 1.0.2 beta 12 から ver 1.1.0 beta 0 と変更
// ver 1.2 beta 1 からスタート
// ver 1.2.2 = 47
// ver 1.2.3 = 48 ? INPUT[0]にバグあり、修正
// ver 1.2.4 = 49 ? SOUND() にバグあり
// 57 = IoT
// ver 1.3 beta 1 からスタート
// ver 1.3.0 = 2 ? IoTを搭載 b24まで
// ver 1.4.0
// ver 1.5.0 for IchigoJam R
