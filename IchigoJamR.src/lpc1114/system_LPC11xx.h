...
//#define USE_SYSTICK // systick使わないと12byte減る system_LPC11xx.cの1行

extern uint32_t SystemCoreClock;     /*!< System Clock Frequency (Core Clock)  */
//extern int32_t SystemCoreClock;     /*!< System Clock Frequency (Core Clock)  */
...
//#define SYSPLLCLKSEL_Val      0x00000000    // 0:IRC // 動かず？
#define SYSPLLCLKSEL_Val      0x00000001    // 1:XTAL and auto

#define SYSPLL_SETUP          1

//#define SYSPLLCTRL_VAL_RATIO 14 // 50MHz
#define SYSPLLCTRL_VAL_RATIO 22 // limit?
#define SYSPLLCTRL_Val_358MHz ((SYSPLLCTRL_VAL_RATIO - 1) | (1 << 5))
#ifdef XTAL_358MHz
#define SYSPLLCTRL_Val        SYSPLLCTRL_Val_358MHz  		// Xtal 3.58MHz x 14 = 50.12MHz
#else
#define SYSPLLCTRL_Val        0x23  		// 0b0100011 48MHz 12MHz x 4 // 1.4.2まで標準
#endif
//#define SYSPLLCTRL_Val        0x42  		// 0b1000010 36MHz 12MHz x 3
//#define SYSPLLCTRL_Val        0x41  		// 0b1000011 24MHz 12MHz x 2
//#define SYSPLLCTRL_Val        ((8 - 1) | (3 << 6))  		// 48MHz 6MHz x 8
//	SYSPLLCTRL = (PLL_M - 1) | (P_SEL << 6);

#define MAINCLKSEL_Val        0x00000003	// 0:IRC 1:PLLIN 2:WDOG 3:PLLOUT
#define SYSAHBCLKDIV_Val      0x00000001 //  0-255 default 1
//#define SYSAHBCLKDIV_Val      0x00000010 // clock down
#define AHBCLKCTRL_Val        0x0001005F
#define SSP0CLKDIV_Val        0x00000001
#define UARTCLKDIV_Val        0x00000001
#define SSP1CLKDIV_Val        0x00000000 // LPC1114にはSPI1ない
